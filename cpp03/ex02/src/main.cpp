...
int main() {
    ...
    std::cout << "Name: " << fourthFragTrap.getName() << "\t\t"
              << "Name: " << firstFragTrap.getName() << '\n';
    std::cout << "Hitpoints: " << fourthFragTrap.getHitPoints() << "\t\t\t"
              << "Hitpoints: " << firstFragTrap.getHitPoints() << '\n';
    std::cout << "Energy Points: " << fourthFragTrap.getEnergyPoints() << "\t\t"
              << "Energy Points: " << firstFragTrap.getEnergyPoints() << '\n';
    std::cout << "Attack Damage: " << fourthFragTrap.getAttackDamage() << "\t\t"
              << "Attack Damage: " << firstFragTrap.getAttackDamage() << '\n';
    std::cout << '\n';
    ...
    std::cout << fragtrap.getName() << " has " << fragtrap.getHitPoints()
              << " hitpoints\n";
    std::cout << fragtrap.getName() << " has " << fragtrap.getEnergyPoints()
              << " energy points\n";
    std::cout << '\n';
