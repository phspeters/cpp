...
int main() {
    ...
    std::cout << "Name: " << fourthScavTrap.getName() << "\t\t"
              << "Name: " << firstScavTrap.getName() << '\n';
    std::cout << "Hitpoints: " << fourthScavTrap.getHitPoints() << "\t\t\t"
              << "Hitpoints: " << firstScavTrap.getHitPoints() << '\n';
    std::cout << "Energy Points: " << fourthScavTrap.getEnergyPoints() << "\t\t"
              << "Energy Points: " << firstScavTrap.getEnergyPoints() << '\n';
    std::cout << "Attack Damage: " << fourthScavTrap.getAttackDamage() << "\t\t"
              << "Attack Damage: " << firstScavTrap.getAttackDamage() << '\n';
    std::cout << '\n';
    ...
    std::cout << scavtrap.getName() << " has " << scavtrap.getHitPoints()
              << " hitpoints\n";
    std::cout << scavtrap.getName() << " has " << scavtrap.getEnergyPoints()
              << " energy points\n";
    std::cout << '\n';
