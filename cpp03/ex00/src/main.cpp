...
int main() {
    ...
    std::cout << "Name: " << fourthClapTrap.getName() << "\t\t"
              << "Name: " << firstClapTrap.getName() << '\n';
    std::cout << "Hitpoints: " << fourthClapTrap.getHitPoints() << "\t\t\t"
              << "Hitpoints: " << firstClapTrap.getHitPoints() << '\n';
    std::cout << "Energy Points: " << fourthClapTrap.getEnergyPoints() << "\t\t"
              << "Energy Points: " << firstClapTrap.getEnergyPoints() << '\n';
    std::cout << "Attack Damage: " << fourthClapTrap.getAttackDamage() << "\t\t"
              << "Attack Damage: " << firstClapTrap.getAttackDamage() << '\n';
    std::cout << '\n';
    ...
    std::cout << claptrap.getName() << " has " << claptrap.getHitPoints()
              << " hitpoints\n";
    std::cout << claptrap.getName() << " has " << claptrap.getEnergyPoints()
              << " energy points\n";
    std::cout << '\n';
