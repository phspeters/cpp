...
int main() {
    ...
    std::cout << "Name: " << fourthDiamondTrap.getName() << "\t\t"
              << "Name: " << firstDiamondTrap.getName() << '\n';
    std::cout << "Hitpoints: " << fourthDiamondTrap.getHitPoints() << "\t\t\t"
              << "Hitpoints: " << firstDiamondTrap.getHitPoints() << '\n';
    std::cout << "Energy Points: " << fourthDiamondTrap.getEnergyPoints()
              << "\t\t"
              << "Energy Points: " << firstDiamondTrap.getEnergyPoints()
              << '\n';
    std::cout << "Attack Damage: " << fourthDiamondTrap.getAttackDamage()
              << "\t\t"
              << "Attack Damage: " << firstDiamondTrap.getAttackDamage()
              << '\n';
    std::cout << '\n';
    ...
    std::cout << diamondtrap.getName() << " has " << diamondtrap.getHitPoints()
              << " hitpoints\n";
    std::cout << diamondtrap.getName() << " has "
              << diamondtrap.getEnergyPoints() << " energy points\n";
    std::cout << '\n';
