...
int	main() {
	{
		...
		std::cout << "--> Everything works as expected, as each object is instantiated as its respective class\n";
		std::cout << '\n';
	}
	{
		std::cout << "\n--------------------------------------------------------------------------------\n";
		...
		std::cout << "--> Notice that the makeSound() function of the base class is called for each object, as they are instantiated as the base class and as such, the derived class is sliced\n";
		std::cout << '\n';
	}
	std::cout << "\n--------------------------------------------------------------------------------\n";
